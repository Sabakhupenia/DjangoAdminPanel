...
class Filterwords(models.Model):
    client = models.OneToOneField('Clients', on_delete=models.CASCADE, db_column='clientid', primary_key=True)
...
class Notifications(models.Model):
    client = models.OneToOneField('Clients', on_delete=models.CASCADE, db_column='clientid', primary_key=True)  # Updated field nam
